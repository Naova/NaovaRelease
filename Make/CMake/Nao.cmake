...
if(BUILD_NAO)
  ...
  target_link_libraries(Nao PRIVATE Nao::opencv2::core Nao::opencv2::imgproc Nao::opencv2::zlib Nao::opencv2::ipp Nao::opencv2::ippcv Nao::opencv2::tbb)
  ...
  target_link_libraries(Nao PRIVATE voronoi::voronoi)
  target_link_libraries(Nao PRIVATE Nao::ONNXRuntime::ONNXRuntime)
