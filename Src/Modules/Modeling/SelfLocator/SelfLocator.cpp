...
Pose2f SelfLocator::getNewPoseReturnFromPenaltyPosition(bool leftSideOfGoal)
{
  ...
  if(leftSideOfGoal)
    return Pose2f(-pi_2, xPosition, theFieldDimensions.yPosLeftSideline + returnFromPenaltyYOffset);
  else
    return Pose2f(pi_2, xPosition, theFieldDimensions.yPosRightSideline - returnFromPenaltyYOffset);
}
