  ...
  lastTimePenaltyMarkSeen(0), lastTimeCirclePerceptSeen(0)
{
  ...
  Vector2f pos3(-2.f * robotPlacementDistance, theFieldDimensions.yPosLeftSideline  +  walkInYModificator);
  Vector2f pos4(-2.f * robotPlacementDistance, theFieldDimensions.yPosRightSideline  - walkInYModificator);
