...
{,
  ...
  {,
    ...
    (float)  returnFromPenaltyYOffset,               /**< When poses are generated after returning from a penalty, a y offset is added to each pose. The absolute value of this offset is defined by this parameter. */
