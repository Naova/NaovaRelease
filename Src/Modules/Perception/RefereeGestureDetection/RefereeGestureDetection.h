...
class RefereeGestureDetection : public RefereeGestureDetectionBase
{
  ...
  /**
   * Set the detected gesture to initialToReady if the robot sees the referee (60° in front).
   * Used for debugging purposes.
   */
  void forceDetectionIfInFrontOfReferee(RefereePercept& theRefereePercept) const;
