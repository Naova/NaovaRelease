...
class NormalTeamC2vs2Card : public NormalTeamC2vs2CardBase
{
  ...
  void execute() override
  {
    ...
    else if (theGameInfo.state == STATE_PLAYING)
    {
      ...
      else if (theRobotInfo.number == 1 && theGameInfo.kickingTeam == theOwnTeamInfo.teamNumber)
      {
        theRoleSkill(PlayerRole(PlayerRole::RoleType::supporter0));
      }
...
MAKE_TEAM_CARD(NormalTeamC2vs2Card);
