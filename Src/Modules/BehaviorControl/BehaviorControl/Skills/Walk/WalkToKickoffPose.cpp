  ...
  option(WalkToKickoffPose)
  {
    ...
    initial_state(walkToKickoffPose)
    {
      ...
      action
      {
        ...
        theWalkToPointSkill(targetRelative, theExtendedGameInfo.walkingInFromSidelines ? 0.7f : 1.f, /* rough: */ targetRelative.translation.norm() < 500.f, theTeamBehaviorStatus.role.isGoalkeeper(), false, true);
      }
    }
