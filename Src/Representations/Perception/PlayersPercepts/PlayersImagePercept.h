/**
 * @file PlayersImagePercept.h
 * @author Michel Bartsch, Andre Mühlenbrock
 */
...
STREAMABLE(PlayersImagePercept,
{
  STREAMABLE(PlayerInImage,
  {,
  ...
  (std::vector<PlayerInImage>) players,
