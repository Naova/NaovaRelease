  ...
  STREAMABLE(TacticState,
  {
    STREAMABLE(Transition,
    {
      ...
      {,
        ...
        (float)(0.f) ballYThreshold, /**< An y coordinate to evaluate the following conditions. */
        ...
        (int)(0) timeSinceBallLeftOfThresholdGE, /**< Lower bound on the time the ball has been behind the above threshold. */
        (int)(0) timeSinceBallRightOfThresholdGE, /**< Lower bound on the time the ball has been ahead of the above threshold. */
      }),
