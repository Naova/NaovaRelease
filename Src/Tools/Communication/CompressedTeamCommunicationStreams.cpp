...
{
  static_assert(NAOVA_STANDARD_MESSAGE_STRUCT_VERSION == 3, "This method is not adjusted for the current message version");
  ...
  out << " */" << endl;
  out << "public class NaovaStandardMessage implements ComplexStreamReader<NaovaStandardMessage> {" << endl;
  out << "    public static final String NAOVA_STANDARD_MESSAGE_STRUCT_HEADER = \"" NAOVA_STANDARD_MESSAGE_STRUCT_HEADER "\";" << endl;
  out << "    public static final short NAOVA_STANDARD_MESSAGE_STRUCT_VERSION = " << NAOVA_STANDARD_MESSAGE_STRUCT_VERSION << ";" << endl;
  out << endl;
  ...
  out << endl;
  out << "    @Override" << endl;
  out << "    public NaovaStandardMessage read(final ByteBuffer stream) {" << endl;
